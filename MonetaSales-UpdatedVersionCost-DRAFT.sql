//
// Moneta Sales Report - Updated VersionCost
...
sql += "SELECT s.sku_id  ";
sql += " ,max(ii.dateRecordAdded) as dra0 ";
sql += "INTO ";
sql += " temporary table tempskudra0 ";
sql += "FROM ";
sql += " ecommerce.SKU s ";
sql += " ,ecommerce.RSInventoryItem ii ";
sql += " ,ecommerce.ProductVersionSKU pvs ";
...
sql += " ,max(ii.merchantPrice) as price ";
sql += "INTO ";
sql += " temporary table skuccost0 ";
sql += "FROM ";
sql += " tempskudra0 as dra0 ";
sql += " ,ecommerce.SKU as s  ";
sql += " ,ecommerce.RSInventoryItem as ii  ";
sql += " ,ecommerce.ProductVersionSKU as pvs ";
sql += "WHERE ";
...
sql += " and s.sku_id = pvs.sku_id ";
sql += " and s.skuBitMask & 1 = 1 ";
sql += " and dra0.sku_id = ii.sku_id ";
sql += " and dra0.dra0 = ii.dateRecordAdded and ii.merchantPrice = 0 ";
sql += "GROUP BY ";
sql += " s.sku_id; ";
...
sql += " skucalc as sca0 ";
sql += "SET ";
sql += " skuCurrentCost = scc0.price  ";
sql += "FROM ";
sql += " skuccost0 as scc0 ";
sql += "WHERE ";
sql += " scc0.sku_id = sca0.sku_id ";
sql += " and sca0.skuCurrentCost is null; ";
...
sql += " ,max(ii.merchantPrice) as cost  ";
sql += "INTO ";
sql += " temporary table skuinitcost0 ";
sql += "FROM ";
sql += " (SELECT ";
sql += "  s.sku_id ";
sql += "  ,min(ii.dateRecordAdded) as dra0 ";
sql += " FROM ";
sql += "  ecommerce.SKU s ";
sql += "  ,ecommerce.RSInventoryItem ii ";
sql += "  ,ecommerce.ProductVersionSKU pvs ";
...
sql += " and s.skuBitMask & 1 = 1 ";
sql += " and dra0.sku_id = ii.sku_id ";
sql += " and dra0.dra0 = ii.dateRecordAdded  ";
sql += " and ii.merchantPrice = 0 ";
sql += "GROUP BY ";
sql += " s.sku_id; ";
...
sql += " skucalc as sca0 ";
sql += "SET ";
sql += " skuInitialCost = sic0.cost  ";
sql += "FROM ";
sql += " skuinitcost0 as sic0 ";
sql += "WHERE ";
sql += " sic0.sku_id = sca0.sku_id ";
sql += " and sca0.skuInitialCost is null; ";
...
sql += "SELECT ";
sql += " sku_id ";
sql += " ,max(merchantPrice) as cost ";
sql += "INTO ";
sql += " temporary table skuac0 ";
sql += "FROM ";
sql += " ecommerce.RSInventoryItem ";
sql += "WHERE ";
sql += " sku_id is not null ";
sql += "GROUP BY ";
sql += " sku_id HAVING sum(quantity) = 0; ";
...
sql += " skucalc as sca0 ";
sql += "SET ";
sql += " skuAverageCost = sac0.cost ";
sql += "FROM ";
sql += " skuac0 as sac0 ";
sql += "WHERE ";
sql += " sac0.sku_id = sca0.sku_id ";
sql += " and sca0.skuPrice is null; ";

sql += "UPDATE ";
sql += " skucalc ";
sql += "SET ";
sql += " skuAverageCost = skuCurrentCost ";
sql += "WHERE ";
sql += " skuAverageCost IS NULL ";
sql += " AND skuCurrentCost IS NOT NULL; ";
...
sql += " AND (sku.date_retired IS NULL OR sku.date_retired::DATE >= date_trunc('month',now()::DATE) - cast('5 years' as interval)) ";
sql += "ORDER BY ";
sql += " sku.item_id ";
sql += " ,sku.sku_id; ";
...
sql += " WHERE ";
sql += " o.oid = order_id ";
sql += " and fulfillmentDate >= '2015-01-01' ";
if(notEmpty(storeId)){
...
sql += " ,sum(quantity * merchantPrice) / sum(quantity) as cost  ";
sql += "into  ";
sql += " temporary table tnupdate1 ";
sql += "from  ";
sql += " ecommerce.RSInventoryItem  ";
sql += "WHERE quantity > 0 ";
sql += "AND merchantPrice > 0 AND sku_id is not null ";
sql += "group by  ";
sql += " sku_id; ";
...
sql += " cost = tnup1.cost ";
sql += "FROM ";
sql += " tnupdate1 as tnup1 ";
sql += "WHERE ";
sql += "tn.sku_id = tnup1.sku_id; ";

sql += "select  ";
sql += " sku_id  ";
sql += " ,max(merchantPrice) as cost  ";
sql += "into  ";
sql += " temporary table tnupdate2 ";
sql += "from  ";
sql += " ecommerce.RSInventoryItem  ";
sql += "where  ";
sql += " (quantity = 0 OR merchantPrice = 0) ";
sql += " and sku_id is not null  ";
sql += "group by  ";
sql += " sku_id; ";
...
sql += " cost = tnup2.cost ";
sql += "FROM  ";
sql += " tnupdate2 as tnup2 ";
sql += "WHERE ";
sql += " tn.sku_id = tnup2.sku_id ";
sql += "AND tn.cost IS NULL; ";
...
sql += "            AND (p1.active = TRUE OR p1.active IS NULL) ";
...
sql += "            AND (p2.active = TRUE OR p2.active IS NULL); ";
...
// versionSkuRevenuePercentage - eight tables of greatness
sql += "SELECT ";
sql += " productVersion_id as versionId ";
sql += " ,sum(customerPrice/quantity) / sum(quantity) as price ";
sql += " INTO temporary table versionWeightedAveragePrice ";
sql += " FROM ";
sql += " ecommerce.RSLineItem ";
sql += " WHERE ";
sql += " fulfillmentDate is not null ";
...
sql += " INTO temporary table Singles ";
sql += " FROM ";
sql += " ecommerce.ProductVersionSKU as pvsku ";
sql += " GROUP BY ";
sql += " productVersion_id  ";
...
sql += " ,vwap.price ";
sql += " INTO temporary table SingleVersionPrice ";
sql += " FROM ";
...
sql += " ,vd.versionName ";
sql += " ,vs2016.units as units2016 ";
sql += " ,vs2016.revenue as rev2016 ";
...
sql += " left outer join versionsales vs2016 on vd.versionId::integer = vs2016.versionId::integer and vs2016.year::varchar = '2016'  ";
