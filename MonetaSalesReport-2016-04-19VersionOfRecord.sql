//
// Moneta Sales Report 
// Catherine Warren, 2016-04-18 | JIRA PRPR-4
// Made into report of record, 2016-04-20
//
...
sql += " WHERE ";
sql += " o.oid = order_id ";
sql += " and fulfillmentDate >= '2014-01-01' ";
if(notEmpty(storeId)){
...
sql += "SELECT  ";
sql += " pv.productversion_id as versionId ";
sql += " ,COALESCE(pr1.customerprice, 0.00) as recommended_sale_price ";
sql += " ,COALESCE(pr2.customerprice, 0.00) as recommended_pop_pick_price ";
sql += "INTO  ";
sql += " temporary table VersionSalePopPickPricing  ";
sql += "FROM  ";
sql += " ecommerce.productversion as pv ";
sql += " , ecommerce.item as i ";
sql += " , ecommerce.price as pr1  ";
sql += " , ecommerce.price as pr2  ";
sql += "WHERE  ";
sql += " pv.item_id = i.item_id ";
sql += " and i.item_id = pr1.source_id and pr1.sourceclass_id = 5 and pr1.pricetype_id = 5";
sql += " and i.item_id = pr2.source_id and pr2.sourceclass_id = 5 and pr2.pricetype_id = 6; ";
...
sql += " ,vspp.recommended_sale_price ";
sql += " ,vspp.recommended_pop_pick_price ";
...
sql += " left outer join VersionSalePopPickPricing vspp on vd.versionId::integer = vspp.versionId::integer ";
...
sql += " ,vd.currentPrice ";
sql += " ,vd.recommended_sale_price ";
sql += " ,vd.recommended_pop_pick_price ";
