...
// edited Catherine Warren, 2015-08-20 | JIRA RPT-92
// edited Catherine Warren, 2016-02-08 | JIRA RPT-133
//
...
sqlProcessor.setSelect("select po.purchaseOrder_id AS po_id, po.poNumber AS po_name, po.buyeruid as buyer,pos.status AS po_status, po.dateIssued::DATE AS create_date ");
