//
// Moneta SKU Inventory Report - DRAFT
// Catherine Warren, 2015-10-07
// To screen out data retired more than 5 years ago
...
//if( notEmpty(SkuPartNumber)){
//    sql += " AND sd.skuPartNumber ILIKE '%" + SkuPartNumber + "%' ";
//}
if( notEmpty(SkuName)){
